...
ds1 = xr.open_dataset("GLDAS_CLSM025_DA1_D.A20101001.022.nc4.SUB.nc4").to_dataframe().to_csv("GLDAS_CLSM025_DA1_D.A20101001.022.nc4.SUB.csv")
ds1 = pd.read_csv("GLDAS_CLSM025_DA1_D.A20101001.022.nc4.SUB.csv")
ds1=ds1[ds1.index.isin(Index)]
ds2 = xr.open_dataset("GLDAS_CLSM025_DA1_D.A20110930.022.nc4.SUB.nc4").to_dataframe().to_csv("GLDAS_CLSM025_DA1_D.A20110930.022.nc4.SUB.csv")
ds2 = pd.read_csv("GLDAS_CLSM025_DA1_D.A20110930.022.nc4.SUB.csv")
ds2=ds2[ds2.index.isin(Index)]
ds3 = xr.open_dataset("GLDAS_CLSM025_DA1_D.A20111001.022.nc4.SUB.nc4").to_dataframe().to_csv("GLDAS_CLSM025_DA1_D.A20111001.022.nc4.SUB.csv")
ds3 = pd.read_csv("GLDAS_CLSM025_DA1_D.A20111001.022.nc4.SUB.csv")
ds3=ds3[ds3.index.isin(Index)]
ds4 = xr.open_dataset("GLDAS_CLSM025_DA1_D.A20120930.022.nc4.SUB.nc4").to_dataframe().to_csv("GLDAS_CLSM025_DA1_D.A20120930.022.nc4.SUB.csv")
ds4 = pd.read_csv("GLDAS_CLSM025_DA1_D.A20120930.022.nc4.SUB.csv")
ds4=ds4[ds4.index.isin(Index)]
ds5 = xr.open_dataset("GLDAS_CLSM025_DA1_D.A20131001.022.nc4.SUB.nc4").to_dataframe().to_csv("GLDAS_CLSM025_DA1_D.A20131001.022.nc4.SUB.csv")
ds5 = pd.read_csv("GLDAS_CLSM025_DA1_D.A20131001.022.nc4.SUB.csv")
ds5=ds5[ds5.index.isin(Index)]
ds6 = xr.open_dataset("GLDAS_CLSM025_DA1_D.A20140930.022.nc4.SUB.nc4").to_dataframe().to_csv("GLDAS_CLSM025_DA1_D.A20140930.022.nc4.SUB.csv")
ds6 = pd.read_csv("GLDAS_CLSM025_DA1_D.A20140930.022.nc4.SUB.csv")
ds6=ds6[ds6.index.isin(Index)]

# print(ds1['TWS_tavg'].tolist())
# print(ds2['TWS_tavg'].tolist())
# print(ds3['TWS_tavg'].tolist())
# print(ds4['TWS_tavg'].tolist())
# print(ds5['TWS_tavg'].tolist())
# print(ds6['TWS_tavg'].tolist())

# sale 90
d1=ds1['TWS_tavg'].tolist()
d2=ds2['TWS_tavg'].tolist()
# sale 91
d3=ds3['TWS_tavg'].tolist()
d4=ds4['TWS_tavg'].tolist()
# sale 93
d5=ds5['TWS_tavg'].tolist()
d6=ds6['TWS_tavg'].tolist()

dif_90=np.average(d2)-np.average(d1)
dif_91=np.average(d4)-np.average(d3)
dif_93=np.average(d6)-np.average(d5)


print('storage difference in year 90:' ,dif_90*175060*0.001)
print('storage difference in year 91:' ,dif_91*175060*0.001)
print('storage difference in year 93:' ,dif_93*175060*0.001)