...
# df = pd.read_csv('GLDAS_NOAH025_M.A201103.021.nc4.SUB.csv')
# Index=[]
...
# LISTE 'Index' khorooji in code az khate 13 ta 26 ast ke  tebghe shape file hoze, index pixelhayi az ncdf ke dakhele shapfile hoze mioftand ra estekhraj karde
...
for parameter in ['Rainf_f_tavg','Evap_tavg','Tair_f_inst']:
    ...
    plt.title(f'{parameter} in year 90')
    plt.show()
# print(dates)